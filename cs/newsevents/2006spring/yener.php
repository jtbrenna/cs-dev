...
<h4 class="subtitle">&quot;<strong>Cell-Graphs for Tissue Representation and Quantification</strong>&quot;</h4>
</p>

<p>
<a href="http://www.cs.rpi.edu/~yener/"><strong>Dr. Bulent Yener</strong></a><br />
Department of Computer Science<br />
Pervasive Computing and Networking Center<br />
Rensselaer Polytechnic Institute
</p>

<p>
<strong>April 24, 2006</strong><br />
12:20 - 1:20 pm<br />
367 Votey Hall</p>

<p><strong>Summary</strong>
<br />
This talk introduces a novel mathematical technique called the cell-graphs to represent and quantify the information encoded in a tissue sample. The cell-graphs are generated from the low-cost, low-magnification tissue images according to the spatial distribution of the cells. The mathematical properties of cell-graphs provide a set of features that can be used by machine learning techniques to characterize the properties of the underlying tissue.
</p>
<p>
It is shown that cell-graph approach leads to successful tissue diagnosis of a brain cancer called "malignant glioma". The cell-graph approach can also be used decision support system in several other areas including tissue engineering, measurement of drug responsiveness, and other types of cancer diagnosis and prognostication. In this talk we will first present the techniques to obtain cell-graphs of glioma and discuss future work.
</p>
<p>
Joint work with Cigdem Demir (RPI) and Hume Gultekin (OHSU).
</p>
...
<br />
This seminar is sponsored by: <a href="http://www.cems.uvm.edu/~cssa/">Computer Science Student Association (CSSA)</a>.
</p>
<p><br />
